...
public final  class StructSdtservidor_temporario implements Cloneable, java.io.Serializable
{
   ...
   public int getSt_pes_id_Z( )
   {
      return gxTv_Sdtservidor_temporario_St_pes_id_Z ;
   }

   public void setSt_pes_id_Z( int value )
   {
      sdtIsNull = (byte)(0) ;
   ...
   protected int gxTv_Sdtservidor_temporario_St_pes_id ;
   protected int gxTv_Sdtservidor_temporario_St_pes_id_Z ;
