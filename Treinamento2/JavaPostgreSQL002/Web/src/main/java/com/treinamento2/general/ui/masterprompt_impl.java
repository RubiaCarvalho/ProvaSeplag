...
public final  class masterprompt_impl extends GXMasterPage
{
   ...
   public void renderHtmlCloseForm022( )
   {
      ...
      httpContext.AddJavascriptSource("general/ui/masterprompt.js", "?20254815253174", false, true);
   ...
   public void wb020( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, divMaintable_Internalname, 1, 0, "px", 0, "px", "ContainerFluid PromptMainTable", "start", "top", "", "", "div");
         /* Div Control */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?20254815253176", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("general/ui/masterprompt.js", "?20254815253176", false, true);
      }
