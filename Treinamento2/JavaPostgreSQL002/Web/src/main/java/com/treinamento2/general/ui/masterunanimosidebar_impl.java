...
public final  class masterunanimosidebar_impl extends GXMasterPage
{
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "vTARGET_MPAGE", AV6target);
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "SIDEBARMENU_MPAGE_Title", GXutil.rtrim( Sidebarmenu_Title));
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "SIDEBARMENU_MPAGE_Distancetotop", GXutil.ltrim( localUtil.ntoc( Sidebarmenu_Distancetotop, (byte)(9), (byte)(0), ".", "")));
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "SIDEBARMENU_MPAGE_Selecteditemtarget", GXutil.rtrim( Sidebarmenu_Selecteditemtarget));
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "SIDEBARMENU_MPAGE_Iscollapsed", GXutil.booltostr( Sidebarmenu_Iscollapsed));
   }
   ...
   public void renderHtmlCloseForm012( )
   {
      ...
      httpContext.AddJavascriptSource("Unanimo_chameleon/chameleon-loader.js", "", false, true);
      httpContext.AddJavascriptSource("UserControls/GeneXusUnanimo.SidebarRender.js", "", false, true);
      httpContext.AddJavascriptSource("general/ui/masterunanimosidebar.js", "?20254815253072", false, true);
   ...
   public void wb010( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( ! ShowMPWhenPopUp( ) && httpContext.isPopUpObject( ) )
         {
            ...
            com.treinamento2.GxWebStd.classAttribute( httpContext, "gx-content-placeholder");
         ...
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, divMaintable_Internalname, 1, 0, "px", 0, "px", "MainContainer", "start", "top", "", "", "div");
         /* Div Control */
         ...
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, divHeader_Internalname, 1, 0, "px", 0, "px", "HeaderContainer ContainerFluid", "start", "top", " "+"data-gx-flex"+" ", "align-items:center;", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 24, "px", "", "start", "top", "", "align-self:center;", "div");
         ...
         com.treinamento2.GxWebStd.gx_bitmap( httpContext, imgImage2_Internalname, sImgUrl, "", "", "", context.getHttpContext().getTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.getHttpContext().getImageSrcSet( sImgUrl), "HLP_General/UI/MasterUnanimoSidebar.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "start", "top", "", "min-height:20px;", "div");
         /* Static images/pictures */
         ...
         com.treinamento2.GxWebStd.gx_bitmap( httpContext, imgImage1_Internalname, sImgUrl, "", "", "", context.getHttpContext().getTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.getHttpContext().getImageSrcSet( sImgUrl), "HLP_General/UI/MasterUnanimoSidebar.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "Center", "top", "", "flex-grow:1;min-height:20px;", "div");
         /* Text block */
         com.treinamento2.GxWebStd.gx_label_ctrl( httpContext, lblApplicationheader_Internalname, "Application Name", "", "", lblApplicationheader_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "header__title", 0, "", 1, 1, 0, (short)(0), "HLP_General/UI/MasterUnanimoSidebar.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "Center", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-2", "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, divTablesidebarcontainer_Internalname, 1, 0, "px", 0, "px", "Table", "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         ...
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, divContent_Internalname, 1, 0, "px", 0, "px", divContent_Class, "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
   ...
   protected void e11012( )
   {
      ...
      new com.treinamento2.general.ui.sidebaritemsdp(remoteHandle, context).execute( GXv_objcol_SdtSidebarItems_SidebarItem2) ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?20254815253081", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("general/ui/masterunanimosidebar.js", "?20254815253082", false, true);
      httpContext.AddJavascriptSource("Unanimo_chameleon/chameleon-loader.js", "", false, true);
      httpContext.AddJavascriptSource("UserControls/GeneXusUnanimo.SidebarRender.js", "", false, true);
