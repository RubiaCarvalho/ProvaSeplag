...
public final  class gx0030_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV11pfp_id = (int)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV11pfp_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11pfp_id), 8, 0));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void gxgrgrid1_refresh_invoke( )
   {
      ...
      AV10cfp_hash = httpContext.GetPar( "cfp_hash") ;
      httpContext.setAjaxCallMode();
      if ( ! httpContext.IsValidAjaxCall( true) )
      {
         GxWebError = (byte)(1) ;
      ...
      gxgrgrid1_refresh( subGrid1_Rows, AV6cfp_id, AV7cpes_id, AV8cfp_data, AV9cfp_bucket, AV10cfp_hash) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.treinamento2.gx0030", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV11pfp_id,8,0))}, new String[] {"pfp_id"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "GXH_vCFP_ID", GXutil.ltrim( localUtil.ntoc( AV6cfp_id, (byte)(8), (byte)(0), ",", "")));
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "GXH_vCPES_ID", GXutil.ltrim( localUtil.ntoc( AV7cpes_id, (byte)(8), (byte)(0), ",", "")));
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "GXH_vCFP_DATA", localUtil.format(AV8cfp_data, "99/99/99"));
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "GXH_vCFP_BUCKET", AV9cfp_bucket);
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "GXH_vCFP_HASH", AV10cfp_hash);
      /* Send saved values. */
      ...
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "vPFP_ID", GXutil.ltrim( localUtil.ntoc( AV11pfp_id, (byte)(8), (byte)(0), ",", "")));
      ...
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "FP_IDFILTERCONTAINER_Class", GXutil.rtrim( divFp_idfiltercontainer_Class));
      ...
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "FP_BUCKETFILTERCONTAINER_Class", GXutil.rtrim( divFp_bucketfiltercontainer_Class));
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "FP_HASHFILTERCONTAINER_Class", GXutil.rtrim( divFp_hashfiltercontainer_Class));
   }
   ...
   {
      return formatLink("com.treinamento2.gx0030", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV11pfp_id,8,0))}, new String[] {"pfp_id"})  ;
   }
   ...
   public void wb080( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, divFp_idfiltercontainer_Internalname, 1, 0, "px", 0, "px", divFp_idfiltercontainer_Class, "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         com.treinamento2.GxWebStd.gx_label_ctrl( httpContext, lblLblfp_idfilter_Internalname, "fp_id", "", "", lblLblfp_idfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11081_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0030.htm");
         ...
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         com.treinamento2.GxWebStd.gx_label_ctrl( httpContext, lblLblpes_idfilter_Internalname, "pes_id", "", "", lblLblpes_idfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12081_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0030.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         com.treinamento2.GxWebStd.gx_single_line_edit( httpContext, edtavCpes_id_Internalname, GXutil.ltrim( localUtil.ntoc( AV7cpes_id, (byte)(8), (byte)(0), ",", "")), GXutil.ltrim( ((edtavCpes_id_Enabled!=0) ? localUtil.format( DecimalUtil.doubleToDec(AV7cpes_id), "ZZZZZZZ9") : localUtil.format( DecimalUtil.doubleToDec(AV7cpes_id), "ZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCpes_id_Jsonclick, 0, "Attribute", "", "", "", "", edtavCpes_id_Visible, edtavCpes_id_Enabled, 0, "text", "1", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "end", false, "", "HLP_Gx0030.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         ...
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, divFp_datafiltercontainer_Internalname, 1, 0, "px", 0, "px", "AdvancedContainerItem AdvancedContainerItemExpanded", "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         com.treinamento2.GxWebStd.gx_label_ctrl( httpContext, lblLblfp_datafilter_Internalname, "fp_data", "", "", lblLblfp_datafilter_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "WWAdvancedLabel WWDateFilterLabel", 0, "", 1, 1, 0, (short)(1), "HLP_Gx0030.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
         /* Attribute/Variable Label */
         com.treinamento2.GxWebStd.gx_label_element( httpContext, edtavCfp_data_Internalname, "fp_data", "col-sm-3 AttributeLabel", 0, true, "");
         /* Single line edit */
         ...
         com.treinamento2.GxWebStd.gx_single_line_edit( httpContext, edtavCfp_data_Internalname, localUtil.format(AV8cfp_data, "99/99/99"), localUtil.format( AV8cfp_data, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'por',false,0);"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCfp_data_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCfp_data_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "end", false, "", "HLP_Gx0030.htm");
         ...
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, divFp_bucketfiltercontainer_Internalname, 1, 0, "px", 0, "px", divFp_bucketfiltercontainer_Class, "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         com.treinamento2.GxWebStd.gx_label_ctrl( httpContext, lblLblfp_bucketfilter_Internalname, "fp_bucket", "", "", lblLblfp_bucketfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e13081_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0030.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, divFp_hashfiltercontainer_Internalname, 1, 0, "px", 0, "px", divFp_hashfiltercontainer_Class, "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         com.treinamento2.GxWebStd.gx_label_ctrl( httpContext, lblLblfp_hashfilter_Internalname, "fp_hash", "", "", lblLblfp_hashfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e14081_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0030.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
         /* Attribute/Variable Label */
         com.treinamento2.GxWebStd.gx_label_element( httpContext, edtavCfp_hash_Internalname, "fp_hash", "col-sm-3 AttributeLabel", 0, true, "");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 56,'',false,'" + sGXsfl_64_idx + "',0)\"" ;
         com.treinamento2.GxWebStd.gx_single_line_edit( httpContext, edtavCfp_hash_Internalname, AV10cfp_hash, GXutil.rtrim( localUtil.format( AV10cfp_hash, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCfp_hash_Jsonclick, 0, "Attribute", "", "", "", "", edtavCfp_hash_Visible, edtavCfp_hash_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "start", true, "", "HLP_Gx0030.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         ...
         StyleString = "" ;
         com.treinamento2.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 64, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e15081_client"+"'", TempTags, "", 2, "HLP_Gx0030.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
      ...
      if ( wbEnd == 64 )
      {
         ...
         StyleString = "" ;
         com.treinamento2.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 64, 2, 0)+","+"null"+");", "Fechar", bttBtn_cancel_Jsonclick, 1, "Fechar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx0030.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 4), "LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) )
                        {
                           ...
                           A14fp_data = GXutil.resetTime(localUtil.ctot( httpContext.cgiGet( edtfp_data_Internalname), 0)) ;
                           n14fp_data = false ;
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 if ( ! wbErr )
                                 {
                                    ...
                                    /* Set Refresh If Cfp_hash Changed */
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vCFP_HASH"), AV10cfp_hash) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   {
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "gxhash_FP_ID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A3fp_id), "ZZZZZZZ9")));
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "FP_ID", GXutil.ltrim( localUtil.ntoc( A3fp_id, (byte)(8), (byte)(0), ".", "")));
   }
   ...
   public void rf082( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.INT, TypeConstants.DATE, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.INT, TypeConstants.DATE, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.STRING,
                                              TypeConstants.BOOLEAN, TypeConstants.INT
                                              }
         });
         lV9cfp_bucket = GXutil.concat( GXutil.rtrim( AV9cfp_bucket), "%", "") ;
         lV10cfp_hash = GXutil.concat( GXutil.rtrim( AV10cfp_hash), "%", "") ;
         /* Using cursor H00082 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV6cfp_id), Integer.valueOf(AV7cpes_id), AV8cfp_data, lV9cfp_bucket, lV10cfp_hash, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_64_idx = 1 ;
         sGXsfl_64_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_64_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_642( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subgrid1_fnc_recordsperpage( ) ) ) )
         {
            A16fp_hash = H00082_A16fp_hash[0] ;
            n16fp_hash = H00082_n16fp_hash[0] ;
            A15fp_bucket = H00082_A15fp_bucket[0] ;
            n15fp_bucket = H00082_n15fp_bucket[0] ;
            A14fp_data = H00082_A14fp_data[0] ;
            n14fp_data = H00082_n14fp_data[0] ;
            A4pes_id = H00082_A4pes_id[0] ;
            A3fp_id = H00082_A3fp_id[0] ;
            /* Execute user event: Load */
            e17082 ();
   ...
   {
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "gxhash_FP_ID"+"_"+sGXsfl_64_idx, getSecureSignedToken( sGXsfl_64_idx, localUtil.format( DecimalUtil.doubleToDec(A3fp_id), "ZZZZZZZ9")));
   }
   ...
   public int subgrid1_fnc_recordcount( )
   {
      ...
      lV10cfp_hash = GXutil.concat( GXutil.rtrim( AV10cfp_hash), "%", "") ;
      /* Using cursor H00083 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV6cfp_id), Integer.valueOf(AV7cpes_id), AV8cfp_data, lV9cfp_bucket, lV10cfp_hash});
   ...
   public void strup080( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         if ( localUtil.vcdate( httpContext.cgiGet( edtavCfp_data_Internalname), (byte)(3)) == 0 )
         {
         ...
         {
            AV8cfp_data = localUtil.ctod( httpContext.cgiGet( edtavCfp_data_Internalname), 3) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8cfp_data", localUtil.format(AV8cfp_data, "99/99/99"));
         }
         ...
         AV10cfp_hash = httpContext.cgiGet( edtavCfp_hash_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV10cfp_hash", AV10cfp_hash);
         ...
         if ( !( GXutil.dateCompare(GXutil.resetTime(localUtil.ctod( httpContext.cgiGet( "GXH_vCFP_DATA"), 3)), GXutil.resetTime(AV8cfp_data)) ) )
         {
            GRID1_nFirstRecordOnPage = 0 ;
         }
         if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vCFP_BUCKET"), AV9cfp_bucket) != 0 )
   ...
   public void e16082( )
   {
      /* Start Routine */
      returnInSub = false ;
      Form.setCaption( GXutil.format( "Lista de Seleção %1", "foto_pessoa", "", "", "", "", "", "", "", "") );
   ...
   public void e18082( )
   {
      ...
      AV11pfp_id = A3fp_id ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11pfp_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11pfp_id), 8, 0));
      httpContext.setWebReturnParms(new Object[] {Integer.valueOf(AV11pfp_id)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV11pfp_id"});
   ...
   {
      AV11pfp_id = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11pfp_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11pfp_id), 8, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20254815253798", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx0030.js", "?20254815253798", false, true);
   ...
   public void subsflControlProps_642( )
   {
      ...
      edtfp_id_Internalname = "FP_ID_"+sGXsfl_64_idx ;
      edtpes_id_Internalname = "PES_ID_"+sGXsfl_64_idx ;
      edtfp_data_Internalname = "FP_DATA_"+sGXsfl_64_idx ;
      edtfp_bucket_Internalname = "FP_BUCKET_"+sGXsfl_64_idx ;
      edtfp_hash_Internalname = "FP_HASH_"+sGXsfl_64_idx ;
   }

   public void subsflControlProps_fel_642( )
   {
      edtavLinkselection_Internalname = "vLINKSELECTION_"+sGXsfl_64_fel_idx ;
      edtfp_id_Internalname = "FP_ID_"+sGXsfl_64_fel_idx ;
      edtpes_id_Internalname = "PES_ID_"+sGXsfl_64_fel_idx ;
      edtfp_data_Internalname = "FP_DATA_"+sGXsfl_64_fel_idx ;
      edtfp_bucket_Internalname = "FP_BUCKET_"+sGXsfl_64_fel_idx ;
      edtfp_hash_Internalname = "FP_HASH_"+sGXsfl_64_fel_idx ;
   }
   ...
   public void sendrow_642( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_64_idx <= subgrid1_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A3fp_id, (byte)(8), (byte)(0), ",", "")))+"'"+"]);" ;
         ...
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtfp_id_Internalname,GXutil.ltrim( localUtil.ntoc( A3fp_id, (byte)(8), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3fp_id), "ZZZZZZZ9"))," dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtfp_id_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(64),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","end",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( Grid1Container.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
         ...
         edtfp_data_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A3fp_id, (byte)(8), (byte)(0), ",", "")))+"'"+"]);" ;
         httpContext.ajax_rsp_assign_prop("", false, edtfp_data_Internalname, "Link", edtfp_data_Link, !bGXsfl_64_Refreshing);
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtfp_data_Internalname,localUtil.format(A14fp_data, "99/99/99"),localUtil.format( A14fp_data, "99/99/99"),"","'"+""+"'"+",false,"+"'"+""+"'",edtfp_data_Link,"","","",edtfp_data_Jsonclick,Integer.valueOf(0),"DescriptionAttribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(64),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","end",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( Grid1Container.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtfp_bucket_Internalname,A15fp_bucket,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtfp_bucket_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn OptionalColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(50),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(64),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","start",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( Grid1Container.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtfp_hash_Internalname,A16fp_hash,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtfp_hash_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn OptionalColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(50),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(64),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","start",Boolean.valueOf(true),""});
   ...
   public void startgridcontrol64( )
   {
      if ( Grid1Container.GetWrapped() == 1 )
      {
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( "fp_hash") ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         Grid1Column.AddObjectProperty("Value", WebUtils.htmlEncode( GXutil.ltrim( localUtil.ntoc( A3fp_id, (byte)(8), (byte)(0), ".", ""))));
         Grid1Container.AddColumnProperties(Grid1Column);
         Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         Grid1Column.AddObjectProperty("Value", WebUtils.htmlEncode( GXutil.ltrim( localUtil.ntoc( A4pes_id, (byte)(8), (byte)(0), ".", ""))));
         Grid1Container.AddColumnProperties(Grid1Column);
         Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         Grid1Column.AddObjectProperty("Value", WebUtils.htmlEncode( localUtil.format(A14fp_data, "99/99/99")));
         Grid1Column.AddObjectProperty("Link", GXutil.rtrim( edtfp_data_Link));
         Grid1Container.AddColumnProperties(Grid1Column);
         Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         Grid1Column.AddObjectProperty("Value", WebUtils.htmlEncode( A15fp_bucket));
         Grid1Container.AddColumnProperties(Grid1Column);
         Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         Grid1Column.AddObjectProperty("Value", WebUtils.htmlEncode( A16fp_hash));
         Grid1Container.AddColumnProperties(Grid1Column);
   ...
   public void init_default_properties( )
   {
      ...
      lblLblfp_hashfilter_Internalname = "LBLFP_HASHFILTER" ;
      edtavCfp_hash_Internalname = "vCFP_HASH" ;
      divFp_hashfiltercontainer_Internalname = "FP_HASHFILTERCONTAINER" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtpes_id_Enabled = 0 ;
      edtfp_id_Enabled = 0 ;
      edtavCfp_hash_Jsonclick = "" ;
      edtavCfp_hash_Enabled = 1 ;
      edtavCfp_hash_Visible = 1 ;
      ...
      divFp_hashfiltercontainer_Class = "AdvancedContainerItem AdvancedContainerItemExpanded" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cfp_id',fld:'vCFP_ID',pic:'ZZZZZZZ9'},{av:'AV7cpes_id',fld:'vCPES_ID',pic:'ZZZZZZZ9'},{av:'AV8cfp_data',fld:'vCFP_DATA',pic:''},{av:'AV9cfp_bucket',fld:'vCFP_BUCKET',pic:''},{av:'AV10cfp_hash',fld:'vCFP_HASH',pic:''}]");
      ...
      setEventMetadata("LBLFP_IDFILTER.CLICK","{handler:'e11081',iparms:[{av:'divFp_idfiltercontainer_Class',ctrl:'FP_IDFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("LBLPES_IDFILTER.CLICK","{handler:'e12081',iparms:[{av:'divPes_idfiltercontainer_Class',ctrl:'PES_IDFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("LBLFP_BUCKETFILTER.CLICK","{handler:'e13081',iparms:[{av:'divFp_bucketfiltercontainer_Class',ctrl:'FP_BUCKETFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("LBLFP_HASHFILTER.CLICK","{handler:'e14081',iparms:[{av:'divFp_hashfiltercontainer_Class',ctrl:'FP_HASHFILTERCONTAINER',prop:'Class'}]");
      setEventMetadata("LBLFP_HASHFILTER.CLICK",",oparms:[{av:'divFp_hashfiltercontainer_Class',ctrl:'FP_HASHFILTERCONTAINER',prop:'Class'},{av:'edtavCfp_hash_Visible',ctrl:'vCFP_HASH',prop:'Visible'}]}");
      setEventMetadata("ENTER","{handler:'e18082',iparms:[{av:'A3fp_id',fld:'FP_ID',pic:'ZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV11pfp_id',fld:'vPFP_ID',pic:'ZZZZZZZ9'}]}");
      setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cfp_id',fld:'vCFP_ID',pic:'ZZZZZZZ9'},{av:'AV7cpes_id',fld:'vCPES_ID',pic:'ZZZZZZZ9'},{av:'AV8cfp_data',fld:'vCFP_DATA',pic:''},{av:'AV9cfp_bucket',fld:'vCFP_BUCKET',pic:''},{av:'AV10cfp_hash',fld:'vCFP_HASH',pic:''}]");
      setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
      setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cfp_id',fld:'vCFP_ID',pic:'ZZZZZZZ9'},{av:'AV7cpes_id',fld:'vCPES_ID',pic:'ZZZZZZZ9'},{av:'AV8cfp_data',fld:'vCFP_DATA',pic:''},{av:'AV9cfp_bucket',fld:'vCFP_BUCKET',pic:''},{av:'AV10cfp_hash',fld:'vCFP_HASH',pic:''}]");
      setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
      setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cfp_id',fld:'vCFP_ID',pic:'ZZZZZZZ9'},{av:'AV7cpes_id',fld:'vCPES_ID',pic:'ZZZZZZZ9'},{av:'AV8cfp_data',fld:'vCFP_DATA',pic:''},{av:'AV9cfp_bucket',fld:'vCFP_BUCKET',pic:''},{av:'AV10cfp_hash',fld:'vCFP_HASH',pic:''}]");
      setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
      setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cfp_id',fld:'vCFP_ID',pic:'ZZZZZZZ9'},{av:'AV7cpes_id',fld:'vCPES_ID',pic:'ZZZZZZZ9'},{av:'AV8cfp_data',fld:'vCFP_DATA',pic:''},{av:'AV9cfp_bucket',fld:'vCFP_BUCKET',pic:''},{av:'AV10cfp_hash',fld:'vCFP_HASH',pic:''}]");
      setEventMetadata("GRID1_LASTPAGE",",oparms:[]}");
      setEventMetadata("NULL","{handler:'valid_Fp_hash',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      lV9cfp_bucket = "" ;
      lV10cfp_hash = "" ;
      H00082_A16fp_hash = new String[] {""} ;
      H00082_n16fp_hash = new boolean[] {false} ;
      H00082_A15fp_bucket = new String[] {""} ;
      H00082_n15fp_bucket = new boolean[] {false} ;
      H00082_A14fp_data = new java.util.Date[] {GXutil.nullDate()} ;
      H00082_n14fp_data = new boolean[] {false} ;
      H00082_A4pes_id = new int[1] ;
      H00082_A3fp_id = new int[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.treinamento2.gx0030__default(),
         new Object[] {
             new Object[] {
            H00082_A16fp_hash, H00082_n16fp_hash, H00082_A15fp_bucket, H00082_n15fp_bucket, H00082_A14fp_data, H00082_n14fp_data, H00082_A4pes_id, H00082_A3fp_id
            }
            , new Object[] {
   ...
   private int edtavCfp_hash_Visible ;
   private int edtavCfp_hash_Enabled ;
   private int A3fp_id ;
   ...
   private String divFp_hashfiltercontainer_Class ;
   ...
   private String divFp_hashfiltercontainer_Internalname ;
   private String lblLblfp_hashfilter_Internalname ;
   private String lblLblfp_hashfilter_Jsonclick ;
   private String edtavCfp_hash_Internalname ;
   private String edtavCfp_hash_Jsonclick ;
   ...
   private String[] H00082_A16fp_hash ;
   private boolean[] H00082_n16fp_hash ;
   private String[] H00082_A15fp_bucket ;
   private boolean[] H00082_n15fp_bucket ;
   private java.util.Date[] H00082_A14fp_data ;
   private boolean[] H00082_n14fp_data ;
   private int[] H00082_A4pes_id ;
   private int[] H00082_A3fp_id ;
...
final  class gx0030__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          int AV6cfp_id )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " fp_hash, fp_bucket, fp_data, pes_id, fp_id" ;
      ...
      if ( ! (GXutil.strcmp("", AV10cfp_hash)==0) )
      {
         addWhere(sWhereString, "(fp_hash like ?)");
      }
      else
      {
         GXv_int1[4] = (byte)(1) ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00082(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).intValue() , (java.util.Date)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).intValue() , (java.util.Date)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , ((Number) dynConstraints[8]).intValue() );
            case 1 :
                  return conditional_H00083(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).intValue() , (java.util.Date)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).intValue() , (java.util.Date)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , ((Number) dynConstraints[8]).intValue() );
      }
