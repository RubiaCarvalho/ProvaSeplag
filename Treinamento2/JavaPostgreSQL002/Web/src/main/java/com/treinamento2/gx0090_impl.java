...
public final  class gx0090_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "pse_pes_id") ;
         ...
         {
            AV8pse_pes_id = (int)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8pse_pes_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8pse_pes_id), 8, 0));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void gxgrgrid1_refresh_invoke( )
   {
      ...
      AV6cse_pes_id = (int)(GXutil.lval( httpContext.GetPar( "cse_pes_id"))) ;
      ...
      gxgrgrid1_refresh( subGrid1_Rows, AV6cse_pes_id, AV7cse_matricula) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.treinamento2.gx0090", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8pse_pes_id,8,0))}, new String[] {"pse_pes_id"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "GXH_vCSE_PES_ID", GXutil.ltrim( localUtil.ntoc( AV6cse_pes_id, (byte)(8), (byte)(0), ",", "")));
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "GXH_vCSE_MATRICULA", AV7cse_matricula);
      /* Send saved values. */
      ...
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "vPSE_PES_ID", GXutil.ltrim( localUtil.ntoc( AV8pse_pes_id, (byte)(8), (byte)(0), ",", "")));
      ...
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "SE_PES_IDFILTERCONTAINER_Class", GXutil.rtrim( divSe_pes_idfiltercontainer_Class));
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "SE_MATRICULAFILTERCONTAINER_Class", GXutil.rtrim( divSe_matriculafiltercontainer_Class));
   }
   ...
   {
      return formatLink("com.treinamento2.gx0090", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8pse_pes_id,8,0))}, new String[] {"pse_pes_id"})  ;
   }
   ...
   public void wb0B0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, divSe_pes_idfiltercontainer_Internalname, 1, 0, "px", 0, "px", divSe_pes_idfiltercontainer_Class, "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         com.treinamento2.GxWebStd.gx_label_ctrl( httpContext, lblLblse_pes_idfilter_Internalname, "se_pes_id", "", "", lblLblse_pes_idfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110b1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0090.htm");
         ...
         com.treinamento2.GxWebStd.gx_label_element( httpContext, edtavCse_pes_id_Internalname, "se_pes_id", "col-sm-3 AttributeLabel", 0, true, "");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_34_idx + "',0)\"" ;
         com.treinamento2.GxWebStd.gx_single_line_edit( httpContext, edtavCse_pes_id_Internalname, GXutil.ltrim( localUtil.ntoc( AV6cse_pes_id, (byte)(8), (byte)(0), ",", "")), GXutil.ltrim( ((edtavCse_pes_id_Enabled!=0) ? localUtil.format( DecimalUtil.doubleToDec(AV6cse_pes_id), "ZZZZZZZ9") : localUtil.format( DecimalUtil.doubleToDec(AV6cse_pes_id), "ZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCse_pes_id_Jsonclick, 0, "Attribute", "", "", "", "", edtavCse_pes_id_Visible, edtavCse_pes_id_Enabled, 0, "text", "1", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "end", false, "", "HLP_Gx0090.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         ...
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, divSe_matriculafiltercontainer_Internalname, 1, 0, "px", 0, "px", divSe_matriculafiltercontainer_Class, "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         com.treinamento2.GxWebStd.gx_label_ctrl( httpContext, lblLblse_matriculafilter_Internalname, "se_matricula", "", "", lblLblse_matriculafilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120b1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0090.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.treinamento2.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e130b1_client"+"'", TempTags, "", 2, "HLP_Gx0090.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
      ...
      if ( wbEnd == 34 )
      {
         ...
         StyleString = "" ;
         com.treinamento2.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "Fechar", bttBtn_cancel_Jsonclick, 1, "Fechar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx0090.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 4), "LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) )
                        {
                           ...
                           A32se_pes_id = (int)(localUtil.ctol( httpContext.cgiGet( edtse_pes_id_Internalname), ",", ".")) ;
                           A27se_matricula = httpContext.cgiGet( edtse_matricula_Internalname) ;
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false ;
                                    /* Set Refresh If Cse_pes_id Changed */
                                    if ( localUtil.ctol( httpContext.cgiGet( "GXH_vCSE_PES_ID"), ",", ".") != AV6cse_pes_id )
                                    {
                                       Rfr0gs = true ;
                                    }
   ...
   {
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "gxhash_SE_PES_ID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A32se_pes_id), "ZZZZZZZ9")));
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "SE_PES_ID", GXutil.ltrim( localUtil.ntoc( A32se_pes_id, (byte)(8), (byte)(0), ".", "")));
   }
   ...
   public void rf0B2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H000B2 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV6cse_pes_id), lV7cse_matricula, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_34_idx = 1 ;
         sGXsfl_34_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_34_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_342( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subgrid1_fnc_recordsperpage( ) ) ) )
         {
            A27se_matricula = H000B2_A27se_matricula[0] ;
            n27se_matricula = H000B2_n27se_matricula[0] ;
            A32se_pes_id = H000B2_A32se_pes_id[0] ;
            /* Execute user event: Load */
            e150B2 ();
   ...
   {
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "gxhash_SE_PES_ID"+"_"+sGXsfl_34_idx, getSecureSignedToken( sGXsfl_34_idx, localUtil.format( DecimalUtil.doubleToDec(A32se_pes_id), "ZZZZZZZ9")));
   }
   ...
   public int subgrid1_fnc_recordcount( )
   {
      ...
      lV7cse_matricula = GXutil.concat( GXutil.rtrim( AV7cse_matricula), "%", "") ;
      /* Using cursor H000B3 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV6cse_pes_id), lV7cse_matricula});
   ...
   public void strup0B0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         if ( ( ( localUtil.ctol( httpContext.cgiGet( edtavCse_pes_id_Internalname), ",", ".") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtavCse_pes_id_Internalname), ",", ".") > 99999999 ) ) )
         {
            httpContext.GX_msglist.addItem(localUtil.getMessages().getMessage("GXM_badnum"), 1, "vCSE_PES_ID");
            GX_FocusControl = edtavCse_pes_id_Internalname ;
            httpContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
            wbErr = true ;
            AV6cse_pes_id = 0 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV6cse_pes_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6cse_pes_id), 8, 0));
         }
         else
         {
            AV6cse_pes_id = (int)(localUtil.ctol( httpContext.cgiGet( edtavCse_pes_id_Internalname), ",", ".")) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV6cse_pes_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6cse_pes_id), 8, 0));
         }
   ...
   public void e140B2( )
   {
      /* Start Routine */
      returnInSub = false ;
      Form.setCaption( GXutil.format( "Lista de Seleção %1", "servidor_efetivo", "", "", "", "", "", "", "", "") );
   ...
   public void e160B2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8pse_pes_id = A32se_pes_id ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8pse_pes_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8pse_pes_id), 8, 0));
      httpContext.setWebReturnParms(new Object[] {Integer.valueOf(AV8pse_pes_id)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8pse_pes_id"});
   ...
   {
      AV8pse_pes_id = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8pse_pes_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8pse_pes_id), 8, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20254815253546", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx0090.js", "?20254815253546", false, true);
   ...
   public void subsflControlProps_342( )
   {
      ...
      edtse_pes_id_Internalname = "SE_PES_ID_"+sGXsfl_34_idx ;
   ...
   public void subsflControlProps_fel_342( )
   {
      ...
      edtse_pes_id_Internalname = "SE_PES_ID_"+sGXsfl_34_fel_idx ;
   ...
   public void sendrow_342( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subgrid1_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A32se_pes_id, (byte)(8), (byte)(0), ",", "")))+"'"+"]);" ;
         ...
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtse_pes_id_Internalname,GXutil.ltrim( localUtil.ntoc( A32se_pes_id, (byte)(8), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A32se_pes_id), "ZZZZZZZ9"))," dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtse_pes_id_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(34),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","end",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( Grid1Container.GetWrapped() == 1 )
         {
         ...
         edtse_matricula_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A32se_pes_id, (byte)(8), (byte)(0), ",", "")))+"'"+"]);" ;
         httpContext.ajax_rsp_assign_prop("", false, edtse_matricula_Internalname, "Link", edtse_matricula_Link, !bGXsfl_34_Refreshing);
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtse_matricula_Internalname,A27se_matricula,"","","'"+""+"'"+",false,"+"'"+""+"'",edtse_matricula_Link,"","","",edtse_matricula_Jsonclick,Integer.valueOf(0),"DescriptionAttribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(20),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(34),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","start",Boolean.valueOf(true),""});
   ...
   public void startgridcontrol34( )
   {
      if ( Grid1Container.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( "se_pes_id") ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         Grid1Column.AddObjectProperty("Value", WebUtils.htmlEncode( GXutil.ltrim( localUtil.ntoc( A32se_pes_id, (byte)(8), (byte)(0), ".", ""))));
         Grid1Container.AddColumnProperties(Grid1Column);
         Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         Grid1Column.AddObjectProperty("Value", WebUtils.htmlEncode( A27se_matricula));
   ...
   {
      lblLblse_pes_idfilter_Internalname = "LBLSE_PES_IDFILTER" ;
      edtavCse_pes_id_Internalname = "vCSE_PES_ID" ;
      divSe_pes_idfiltercontainer_Internalname = "SE_PES_IDFILTERCONTAINER" ;
      ...
      edtse_pes_id_Internalname = "SE_PES_ID" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtavCse_pes_id_Jsonclick = "" ;
      edtavCse_pes_id_Enabled = 1 ;
      edtavCse_pes_id_Visible = 1 ;
      divSe_matriculafiltercontainer_Class = "AdvancedContainerItem AdvancedContainerItemExpanded" ;
      divSe_pes_idfiltercontainer_Class = "AdvancedContainerItem AdvancedContainerItemExpanded" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cse_pes_id',fld:'vCSE_PES_ID',pic:'ZZZZZZZ9'},{av:'AV7cse_matricula',fld:'vCSE_MATRICULA',pic:''}]");
      ...
      setEventMetadata("LBLSE_PES_IDFILTER.CLICK","{handler:'e110B1',iparms:[{av:'divSe_pes_idfiltercontainer_Class',ctrl:'SE_PES_IDFILTERCONTAINER',prop:'Class'}]");
      setEventMetadata("LBLSE_PES_IDFILTER.CLICK",",oparms:[{av:'divSe_pes_idfiltercontainer_Class',ctrl:'SE_PES_IDFILTERCONTAINER',prop:'Class'},{av:'edtavCse_pes_id_Visible',ctrl:'vCSE_PES_ID',prop:'Visible'}]}");
      setEventMetadata("LBLSE_MATRICULAFILTER.CLICK","{handler:'e120B1',iparms:[{av:'divSe_matriculafiltercontainer_Class',ctrl:'SE_MATRICULAFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("ENTER","{handler:'e160B2',iparms:[{av:'A32se_pes_id',fld:'SE_PES_ID',pic:'ZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8pse_pes_id',fld:'vPSE_PES_ID',pic:'ZZZZZZZ9'}]}");
      setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cse_pes_id',fld:'vCSE_PES_ID',pic:'ZZZZZZZ9'},{av:'AV7cse_matricula',fld:'vCSE_MATRICULA',pic:''}]");
      setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
      setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cse_pes_id',fld:'vCSE_PES_ID',pic:'ZZZZZZZ9'},{av:'AV7cse_matricula',fld:'vCSE_MATRICULA',pic:''}]");
      setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
      setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cse_pes_id',fld:'vCSE_PES_ID',pic:'ZZZZZZZ9'},{av:'AV7cse_matricula',fld:'vCSE_MATRICULA',pic:''}]");
      setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
      setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cse_pes_id',fld:'vCSE_PES_ID',pic:'ZZZZZZZ9'},{av:'AV7cse_matricula',fld:'vCSE_MATRICULA',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      GX_FocusControl = "" ;
      sPrefix = "" ;
      lblLblse_pes_idfilter_Jsonclick = "" ;
      TempTags = "" ;
      ...
      A27se_matricula = "" ;
      lV7cse_matricula = "" ;
      H000B2_A27se_matricula = new String[] {""} ;
      H000B2_n27se_matricula = new boolean[] {false} ;
      H000B2_A32se_pes_id = new int[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.treinamento2.gx0090__default(),
         new Object[] {
             new Object[] {
            H000B2_A27se_matricula, H000B2_n27se_matricula, H000B2_A32se_pes_id
            }
            , new Object[] {
   ...
   private int AV8pse_pes_id ;
   private int nGXsfl_34_idx=1 ;
   private int AV6cse_pes_id ;
   private int edtavCse_pes_id_Enabled ;
   private int edtavCse_pes_id_Visible ;
   ...
   private int edtse_pes_id_Enabled ;
   ...
   private String divSe_pes_idfiltercontainer_Class ;
   ...
   private String divSe_pes_idfiltercontainer_Internalname ;
   private String lblLblse_pes_idfilter_Internalname ;
   private String lblLblse_pes_idfilter_Jsonclick ;
   private String edtavCse_pes_id_Internalname ;
   private String TempTags ;
   private String edtavCse_pes_id_Jsonclick ;
   ...
   private String edtse_pes_id_Internalname ;
   ...
   private String edtse_pes_id_Jsonclick ;
   ...
   private String[] H000B2_A27se_matricula ;
   private boolean[] H000B2_n27se_matricula ;
   private int[] H000B2_A32se_pes_id ;
...
final  class gx0090__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          int AV6cse_pes_id )
   {
      ...
      if ( ! (GXutil.strcmp("", AV7cse_matricula)==0) )
      {
         addWhere(sWhereString, "(se_matricula like ?)");
      }
      else
      {
         GXv_int1[1] = (byte)(1) ;
      }
      sOrderString += " ORDER BY se_pes_id" ;
                                          ...
                                          int AV6cse_pes_id )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM servidor_efetivo" ;
      addWhere(sWhereString, "(se_pes_id >= ?)");
      if ( ! (GXutil.strcmp("", AV7cse_matricula)==0) )
      {
         addWhere(sWhereString, "(se_matricula like ?)");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000B2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).intValue() );
            case 1 :
                  return conditional_H000B3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).intValue() );
      }
