...
public final  class gx00a0_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "punidade_id") ;
         ...
         {
            AV8punidade_id = (int)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8punidade_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8punidade_id), 8, 0));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void gxgrgrid1_refresh_invoke( )
   {
      ...
      AV6cunidade_id = (int)(GXutil.lval( httpContext.GetPar( "cunidade_id"))) ;
      ...
      gxgrgrid1_refresh( subGrid1_Rows, AV6cunidade_id, AV7cendereco_id) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.treinamento2.gx00a0", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8punidade_id,8,0))}, new String[] {"punidade_id"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "GXH_vCUNIDADE_ID", GXutil.ltrim( localUtil.ntoc( AV6cunidade_id, (byte)(8), (byte)(0), ",", "")));
      ...
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "vPUNIDADE_ID", GXutil.ltrim( localUtil.ntoc( AV8punidade_id, (byte)(8), (byte)(0), ",", "")));
   ...
   {
      return formatLink("com.treinamento2.gx00a0", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8punidade_id,8,0))}, new String[] {"punidade_id"})  ;
   }
   ...
   public void wb0C0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         com.treinamento2.GxWebStd.gx_label_ctrl( httpContext, lblLblunidade_idfilter_Internalname, "unidade_id", "", "", lblLblunidade_idfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110c1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx00A0.htm");
         ...
         com.treinamento2.GxWebStd.gx_single_line_edit( httpContext, edtavCunidade_id_Internalname, GXutil.ltrim( localUtil.ntoc( AV6cunidade_id, (byte)(8), (byte)(0), ",", "")), GXutil.ltrim( ((edtavCunidade_id_Enabled!=0) ? localUtil.format( DecimalUtil.doubleToDec(AV6cunidade_id), "ZZZZZZZ9") : localUtil.format( DecimalUtil.doubleToDec(AV6cunidade_id), "ZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCunidade_id_Jsonclick, 0, "Attribute", "", "", "", "", edtavCunidade_id_Visible, edtavCunidade_id_Enabled, 0, "text", "1", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "end", false, "", "HLP_Gx00A0.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         ...
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         com.treinamento2.GxWebStd.gx_label_ctrl( httpContext, lblLblendereco_idfilter_Internalname, "endereco_id", "", "", lblLblendereco_idfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120c1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx00A0.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.treinamento2.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e130c1_client"+"'", TempTags, "", 2, "HLP_Gx00A0.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.treinamento2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
      ...
      if ( wbEnd == 34 )
      {
         ...
         StyleString = "" ;
         com.treinamento2.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "Fechar", bttBtn_cancel_Jsonclick, 1, "Fechar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx00A0.htm");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.treinamento2.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 if ( ! wbErr )
                                 {
                                    ...
                                    if ( localUtil.ctol( httpContext.cgiGet( "GXH_vCUNIDADE_ID"), ",", ".") != AV6cunidade_id )
                                    {
                                       Rfr0gs = true ;
                                    }
   ...
   {
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "gxhash_UNIDADE_ID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A33unidade_id), "ZZZZZZZ9")));
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "UNIDADE_ID", GXutil.ltrim( localUtil.ntoc( A33unidade_id, (byte)(8), (byte)(0), ".", "")));
   }
   ...
   public void rf0C2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              Integer.valueOf(AV6cunidade_id) } ,
                                              new int[]{
                                              TypeConstants.INT, TypeConstants.INT, TypeConstants.INT
                                              }
         });
         /* Using cursor H000C2 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV6cunidade_id), Integer.valueOf(AV7cendereco_id), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_34_idx = 1 ;
         sGXsfl_34_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_34_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_342( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subgrid1_fnc_recordsperpage( ) ) ) )
         {
            A30endereco_id = H000C2_A30endereco_id[0] ;
            A33unidade_id = H000C2_A33unidade_id[0] ;
            /* Execute user event: Load */
            e150C2 ();
   ...
   {
      com.treinamento2.GxWebStd.gx_hidden_field( httpContext, "gxhash_UNIDADE_ID"+"_"+sGXsfl_34_idx, getSecureSignedToken( sGXsfl_34_idx, localUtil.format( DecimalUtil.doubleToDec(A33unidade_id), "ZZZZZZZ9")));
   }
   ...
   public int subgrid1_fnc_recordcount( )
   {
      ...
      /* Using cursor H000C3 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV6cunidade_id), Integer.valueOf(AV7cendereco_id)});
   ...
   public void strup0C0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         if ( ( ( localUtil.ctol( httpContext.cgiGet( edtavCunidade_id_Internalname), ",", ".") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtavCunidade_id_Internalname), ",", ".") > 99999999 ) ) )
         {
            ...
            wbErr = true ;
            AV6cunidade_id = 0 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV6cunidade_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6cunidade_id), 8, 0));
         }
         else
         {
            AV6cunidade_id = (int)(localUtil.ctol( httpContext.cgiGet( edtavCunidade_id_Internalname), ",", ".")) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV6cunidade_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6cunidade_id), 8, 0));
         }
   ...
   public void e140C2( )
   {
      /* Start Routine */
      returnInSub = false ;
      Form.setCaption( GXutil.format( "Lista de Seleção %1", "unidade_endereco", "", "", "", "", "", "", "", "") );
   ...
   public void e160C2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8punidade_id = A33unidade_id ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8punidade_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8punidade_id), 8, 0));
      httpContext.setWebReturnParms(new Object[] {Integer.valueOf(AV8punidade_id)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8punidade_id"});
   ...
   {
      AV8punidade_id = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8punidade_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8punidade_id), 8, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20254815253883", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx00a0.js", "?20254815253883", false, true);
   ...
   public void sendrow_342( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subgrid1_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A33unidade_id, (byte)(8), (byte)(0), ",", "")))+"'"+"]);" ;
         ...
         edtunidade_id_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A33unidade_id, (byte)(8), (byte)(0), ",", "")))+"'"+"]);" ;
         httpContext.ajax_rsp_assign_prop("", false, edtunidade_id_Internalname, "Link", edtunidade_id_Link, !bGXsfl_34_Refreshing);
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtunidade_id_Internalname,GXutil.ltrim( localUtil.ntoc( A33unidade_id, (byte)(8), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A33unidade_id), "ZZZZZZZ9"))," dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'",edtunidade_id_Link,"","","",edtunidade_id_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(34),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","end",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( Grid1Container.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
   ...
   public void startgridcontrol34( )
   {
      ...
      else
      {
         ...
         Grid1Column.AddObjectProperty("Link", GXutil.rtrim( edtunidade_id_Link));
         Grid1Container.AddColumnProperties(Grid1Column);
         Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cunidade_id',fld:'vCUNIDADE_ID',pic:'ZZZZZZZ9'},{av:'AV7cendereco_id',fld:'vCENDERECO_ID',pic:'ZZZZZZZ9'}]");
      ...
      setEventMetadata("LBLUNIDADE_IDFILTER.CLICK","{handler:'e110C1',iparms:[{av:'divUnidade_idfiltercontainer_Class',ctrl:'UNIDADE_IDFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("LBLENDERECO_IDFILTER.CLICK","{handler:'e120C1',iparms:[{av:'divEndereco_idfiltercontainer_Class',ctrl:'ENDERECO_IDFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("ENTER","{handler:'e160C2',iparms:[{av:'A33unidade_id',fld:'UNIDADE_ID',pic:'ZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8punidade_id',fld:'vPUNIDADE_ID',pic:'ZZZZZZZ9'}]}");
      setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cunidade_id',fld:'vCUNIDADE_ID',pic:'ZZZZZZZ9'},{av:'AV7cendereco_id',fld:'vCENDERECO_ID',pic:'ZZZZZZZ9'}]");
      setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
      setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cunidade_id',fld:'vCUNIDADE_ID',pic:'ZZZZZZZ9'},{av:'AV7cendereco_id',fld:'vCENDERECO_ID',pic:'ZZZZZZZ9'}]");
      setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
      setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cunidade_id',fld:'vCUNIDADE_ID',pic:'ZZZZZZZ9'},{av:'AV7cendereco_id',fld:'vCENDERECO_ID',pic:'ZZZZZZZ9'}]");
      setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
      setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cunidade_id',fld:'vCUNIDADE_ID',pic:'ZZZZZZZ9'},{av:'AV7cendereco_id',fld:'vCENDERECO_ID',pic:'ZZZZZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      H000C2_A30endereco_id = new int[1] ;
      H000C2_A33unidade_id = new int[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.treinamento2.gx00a0__default(),
         new Object[] {
             new Object[] {
            H000C2_A30endereco_id, H000C2_A33unidade_id
            }
            , new Object[] {
   ...
   private int AV8punidade_id ;
   private int nGXsfl_34_idx=1 ;
   private int AV6cunidade_id ;
   ...
   private String edtunidade_id_Link ;
   ...
   private int[] H000C2_A30endereco_id ;
   private int[] H000C2_A33unidade_id ;
...
final  class gx00a0__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          int AV6cunidade_id )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " endereco_id, unidade_id" ;
      sFromString = " FROM unidade_endereco" ;
      sOrderString = "" ;
      ...
      sOrderString += " ORDER BY unidade_id" ;
                                          ...
                                          int AV6cunidade_id )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM unidade_endereco" ;
      addWhere(sWhereString, "(unidade_id >= ?)");
      if ( ! (0==AV7cendereco_id) )
      {
         addWhere(sWhereString, "(endereco_id >= ?)");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000C2(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).intValue() , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).intValue() );
            case 1 :
                  return conditional_H000C3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).intValue() , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).intValue() );
      }
